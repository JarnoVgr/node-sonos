 ...
 */
Sonos.prototype.getAllGroups = function () {
 ...
 * @returns {Boolean}
 */
Sonos.prototype.joinGroup = async function (otherDeviceName) {
  ...
  debug('Sonos.joinGroup(%j)', otherDeviceName)
    ...
    const groups = await this.getAllGroups();
      ...
      if (!groupToJoin) {
        ...
        resolve(this.setAVTransportURI({ uri: `x-rincon:${groupToJoin.Coordinator}`, onlySetUri: true }));
